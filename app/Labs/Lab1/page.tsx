    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Whisk yogurt and egg until smooth</li>
          <li>Add flour, sugar, baking powder, salt and, mix gently.</li>
          <li>Cook spoonfuls on a buttered pan until bubbles, then flip.</li>
          <li>Serve with honey, crushed nuts, and cinnamon.</li>
        </ol>
      ...
      <br />
      Please{" "}
      <a href="https://github.com/mrinalsetty/kambaz-next-js" id="wd-github">
        click here
      </a>{" "}
      to view the code repository on GitHub
      <br />{" "}
    </div>
  );
}
